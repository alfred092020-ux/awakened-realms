...
PRODUCTION_FILES = (
    ...
    "lib/logres_chat_watchdog.py",
    "lib/logres_chat_contract.py",
    "lib/logres_phone_local_ai.py",
    ...
    "config/chat_watchdog.default.json",
    ...
    "bin/logres-factory-metrics",
    "bin/logres-gate",
    "bin/logres-peer-consult",
    "bin/logres-superbrain",
