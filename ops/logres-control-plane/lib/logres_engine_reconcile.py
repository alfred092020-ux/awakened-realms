...
ROUTE_TERMINAL_SUPERSEDE={"ASSIGNING","ROUTED","ACTIVE","PR_READY","VERIFYING","QUEUED"}
ROUTE_LIVE=set(ROUTE_TERMINAL_SUPERSEDE)
...
def apply(conn):
    ...
    for a in actions:
        if a["engine"]=="copilot":
            ...
            if a["from_state"] in ROUTE_TERMINAL_SUPERSEDE:
