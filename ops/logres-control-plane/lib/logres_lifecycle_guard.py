...
KNOWN = {
 ...
 "preflight":{"PENDING","RUNNING","VERIFIED","FAILED","APPLIED","STALE","DEFERRED_BUSY"},
...
TERMINAL = {
 ...
 "preflight":{"FAILED","APPLIED","STALE","DEFERRED_BUSY"},
...
TRANSITIONS = {
 ...
 "preflight":{
  None:{"PENDING","RUNNING","VERIFIED","FAILED","APPLIED","STALE","DEFERRED_BUSY"},
  "PENDING":{"RUNNING","STALE","FAILED","DEFERRED_BUSY"},
  "RUNNING":{"VERIFIED","FAILED","STALE","DEFERRED_BUSY"},
  "VERIFIED":{"APPLIED","STALE","FAILED"},
  "FAILED":{"STALE"},"APPLIED":set(),"STALE":set(),"DEFERRED_BUSY":set(),
 },
 "swarm":{
